...
<br><img src="Site_Photos/US_Water_Stress.png" style="height:300px; width:auto; display:block; margin-left:auto; margin-right:auto;"><br>
...
As AI becomes more prominent in everyday life, the need for sustainable AI development becomes increasingly important. Bringing attention to this issue is helpful, but some concrete actions could be:

  1. Moving model training to areas that are not water stressed.
  2. Push for AI training to use solely renewable energy.
  3. Take steps to ensure that obsolete hardware is disposed of correctly